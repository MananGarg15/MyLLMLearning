...
{links}    
    """
    print(f'selecting relevant links from {url} by calling gpt_oss')
    response = Llms.callGPT_OSS(system_prompt=links_system_prompt,message=links_user_prompt,new=True, response_format = "json_object")
