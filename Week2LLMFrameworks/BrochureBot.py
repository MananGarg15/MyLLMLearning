...
def wrapLlm(url,company_name,source,model,temperature,chat_no):
    
    yield from getBrochure(url, company_name, source=source, model=model, temperature=temperature, chat_no=chat_no)
